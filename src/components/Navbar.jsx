...
const Navbar = () => {
    ...
    useEffect(() => {
        ...
        // Set initial loading state based on online status
    ...
    return (
        <div className="navbar bg-slate-600 px-5 py-5 rounded-[20px] h-[12%]">
            ...
            <div className="flex-none gap-2">
                <div>
                    <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-[100px] p-2 shadow">
                ...
                <div className="form-control">
                    <input type="text" placeholder={t('search')} className="input input-bordered w-24 md:w-auto" />
                </div>
                <div>
                    <p>{t('greeting')}</p>
                </div>
                <div className="dropdown dropdown-end">
                    ...
                    <ul
                        ...
                        <li><a>{t('setting')}</a></li>
                        <li><a onClick={handleLogout}>{t('longout')}</a></li>
                    </ul>
                </div>
            </div>
        </div>
